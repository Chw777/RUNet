...
class Pretrainer:
    ...
    def run(self, epochs=20):
        ...
        for epoch in range(epochs):
            self.train_epoch()
            print(f"Pretrain Epoch {epoch + 1}/{epochs} | Training completed")
        self.save_checkpoint()
        print(f"✅ Pretraining finished for A{self.subject_id:02d}, checkpoint saved!")
